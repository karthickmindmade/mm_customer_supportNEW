...
export default function TeamDashboardLayout(props){
...
const onBackButtonEvent3 = () => {
  ...
  const items = [
    {
      href: '/components/dash/teamdashboard',
      icon: (<DashboardIcon />),
      title: 'Dashboard'
    },
    {
      href: '/components/tickets/teamticket',
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="fixed" open={open}>
          ...
          >
            ...
            <a onClick={onBackButtonEvent3} className="text-white">Logout</a>
            {props.menuBar}
